...
| When | What | Commit |
|---|---|---|
| 2026-09-25 13:25 | About dialog: wider, with a Data section and a table of providers (country, provider link, station count on the shown date, licence link) and a Project section. | About dialog with data table |
